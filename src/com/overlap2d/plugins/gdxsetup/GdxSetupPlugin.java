...
public class GdxSetupPlugin extends O2DPluginAdapter {
    public static final String CLASS_NAME = "com.uwsoft.editor.plugins.gdxsetup";
    ...
    private SwingDialogMediator mediator;

    public GdxSetupPlugin() {
        mediator = new SwingDialogMediator(this);
    }

    @Override
    public void initPlugin() {
        facade.registerMediator(mediator);
        pluginAPI.addMenuItem(WINDOWS_MENU, "Gdx Setup-App", PANEL_OPEN);
    }
}
